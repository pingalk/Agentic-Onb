                ...
                <div className="flex items-center">
                  <svg width="120" height="28" viewBox="0 0 120 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clipPath="url(#clip0)">
                      <path d="M24.24 10.432c0-2.24-.64-4.032-2.816-4.032H17.6v8.064h3.824c2.176 0 2.816-1.792 2.816-4.032zm-2.816 6.208H17.6v8.96h-3.136V4.224h6.96c4.032 0 5.952 2.496 5.952 6.208 0 2.624-1.088 4.608-3.2 5.568l4.032 9.6h-3.392l-3.392-8.96zM35.984 17.92c-.896 0-1.408.64-1.408 1.472v1.728c0 .832.512 1.472 1.408 1.472.896 0 1.408-.64 1.408-1.472v-1.728c0-.832-.512-1.472-1.408-1.472zm-4.544 3.2v-1.728c0-2.496 1.728-4.032 4.544-4.032s4.544 1.536 4.544 4.032v1.728c0 2.496-1.728 4.032-4.544 4.032s-4.544-1.536-4.544-4.032zM48.56 25.6l-4.928-6.72v6.72h-3.136V15.552h3.136l4.928 6.72v-6.72h3.136V25.6H48.56zM61.488 17.92c-.896 0-1.408.64-1.408 1.472v1.728c0 .832.512 1.472 1.408 1.472.896 0 1.408-.64 1.408-1.472v-1.728c0-.832-.512-1.472-1.408-1.472zm-4.544 3.2v-1.728c0-2.496 1.728-4.032 4.544-4.032s4.544 1.536 4.544 4.032v1.728c0 2.496-1.728 4.032-4.544 4.032s-4.544-1.536-4.544-4.032zM74.064 17.92c-.896 0-1.408.64-1.408 1.472v1.728c0 .832.512 1.472 1.408 1.472.896 0 1.408-.64 1.408-1.472v-1.728c0-.832-.512-1.472-1.408-1.472zm-4.544 3.2v-1.728c0-2.496 1.728-4.032 4.544-4.032s4.544 1.536 4.544 4.032v1.728c0 2.496-1.728 4.032-4.544 4.032s-4.544-1.536-4.544-4.032zM86.64 25.6h-3.136V4.224h8.064c4.032 0 5.952 2.496 5.952 6.208 0 3.712-1.92 6.208-5.952 6.208H86.64v9.6zm0-12.16h4.928c2.176 0 2.816-1.792 2.816-4.032 0-2.24-.64-4.032-2.816-4.032H86.64v8.064zM106.128 17.92c-.896 0-1.408.64-1.408 1.472v1.728c0 .832.512 1.472 1.408 1.472.896 0 1.408-.64 1.408-1.472v-1.728c0-.832-.512-1.472-1.408-1.472zm-4.544 3.2v-1.728c0-2.496 1.728-4.032 4.544-4.032s4.544 1.536 4.544 4.032v1.728c0 2.496-1.728 4.032-4.544 4.032s-4.544-1.536-4.544-4.032zM119.024 15.552l-2.88 6.528-2.88-6.528h-3.136l4.544 10.048h2.944l4.544-10.048h-3.136z" fill="white"/>
                      <path d="M10.56 4.224H0v8.064h7.424c2.176 0 2.816-1.792 2.816-4.032 0-2.24-.64-4.032-2.816-4.032H10.56z" fill="#3395FF"/>
                      <path d="M10.56 4.224l4.544 10.048-4.544 11.328H0l10.56-21.376z" fill="url(#paint0_linear)"/>
                    </g>
                    <defs>
                      <linearGradient id="paint0_linear" x1="5.28" y1="4.224" x2="5.28" y2="25.6" gradientUnits="userSpaceOnUse">
